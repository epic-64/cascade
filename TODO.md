## Todos
- [ ] the bureau should send a projectile to the tile it upgrades, for better visual feedback
- [ ] when placing a politician into a townhall, there is a sub second time window for dropping it. The drop area keeps disappearing and reappearing,
...
- [ ] the politician roster should be a bit wider to allow longer descriptions to remain as one line
