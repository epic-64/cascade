...
// Dev workflow: watches all sources, recompiles JS, and restarts the server automatically
// Usage: sbt dev  (then edit any file and save — server auto-restarts)
addCommandAlias("dev", "~js/fastLinkJS;jvm/reStart")
